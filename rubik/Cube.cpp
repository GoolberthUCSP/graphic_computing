...
void Cube::moves(std::string sequence, bool save) {
  ...
  if(save) solution+=printSequence(sequence);
  //output();
}
...
void Cube::M(int n) {
  ...
  if (n>=0) {
    ...
    for (int x=0; x<n; ++x) {
      ...
      //White->Orange
      newCubies[1][4] = Cube::cubies[7][0];
      newCubies[4][4] = Cube::cubies[4][0];
      newCubies[7][4] = Cube::cubies[1][0];

      //Orange->Yellow
      newCubies[7][1] = Cube::cubies[1][4];
      newCubies[4][1] = Cube::cubies[4][4];
      newCubies[1][1] = Cube::cubies[7][4];

      //Yellow->Red
      newCubies[1][2] = Cube::cubies[1][1];
      newCubies[4][2] = Cube::cubies[4][1];
      newCubies[7][2] = Cube::cubies[7][1];

      //Red->White
      newCubies[1][0] = Cube::cubies[1][2];
      newCubies[4][0] = Cube::cubies[4][2];
      newCubies[7][0] = Cube::cubies[7][2];
...
void Cube::E(int n) {
  ...
  if (n>=0) {
    ...
    for (int x=0; x<n; ++x) {
      ...
      //Orange->Green
      newCubies[3][3] = Cube::cubies[3][4];
      newCubies[4][3] = Cube::cubies[4][4];
      newCubies[5][3] = Cube::cubies[5][4];

      //Green->Red
      newCubies[3][2] = Cube::cubies[3][3];
      newCubies[4][2] = Cube::cubies[4][3];
      newCubies[5][2] = Cube::cubies[5][3];

      //Red->Blue
      newCubies[3][5] = Cube::cubies[3][2];
      newCubies[4][5] = Cube::cubies[4][2];
      newCubies[5][5] = Cube::cubies[5][2];

      //Blue->Orange
      newCubies[3][4] = Cube::cubies[3][5];
      newCubies[4][4] = Cube::cubies[4][5];
      newCubies[5][4] = Cube::cubies[5][5];
...
void Cube::S(int n) {
  ...
  if (n>=0) {
    ...
    for (int x=0; x<n; ++x) {
      //Blue->Yellow
      newCubies[5][1] = Cube::cubies[1][5];
      newCubies[4][1] = Cube::cubies[4][5];
      newCubies[3][1] = Cube::cubies[7][5];

      //Yellow->Green
      newCubies[1][3] = Cube::cubies[3][1];
      newCubies[4][3] = Cube::cubies[4][1];
      newCubies[7][3] = Cube::cubies[5][1];

      //Green->White
      newCubies[5][0] = Cube::cubies[1][3];
      newCubies[4][0] = Cube::cubies[4][3];
      newCubies[3][0] = Cube::cubies[7][3];

      //White->Blue
      newCubies[1][5] = Cube::cubies[3][0];
      newCubies[4][5] = Cube::cubies[4][0];
      newCubies[7][5] = Cube::cubies[5][0];
